...
path_data = pd.DataFrame([
   ["n01", None, "s1", "source", "blue", "rect"],
   ["n02", None, "s2", "source", "blue", "rect"],
   ["n03", "n01", "t1", "temp", "grey", "rect"],
   ["n03", "n02", "t1", "temp", "grey", "rect"],
   ["n04", "n01", "t2", "temp", "grey", "rect"],
   ["n04", "n03", "t2", "temp", "grey", "rect"],
   ["n05", "n04", "mytable", "target", "green", "doubleoctagon"],
],
   columns=["child", "parent", "name", "info", "color", "shape"]
)
dagr = dataframe_to_dag(path_data)
#print(dagr.describe())
#print(dagr.get_attr("info"))
dag_graph = dag_to_dot(dagr, node_attr="node_attr")
